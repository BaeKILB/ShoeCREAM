...
<%-- 				${buyer} --%>
<!-- 				<b>배송지 정보</b><br> -->
<!-- 				<input type="checkbox"  id="sameAsMemberInfo"  onclick="toggleInputs()" checked>배송지 정보와 회원 정보가 동일합니다. -->
<!--     <script> -->
//         function toggleInputs() {
//             var isChecked = document.getElementById('sameAsMemberInfo').checked;
//             var inputs = document.querySelectorAll('input[type="text"], input[type="button"]');
//             var spans = document.querySelectorAll('#buyerName, #buyerAddr, #buyerPhone');
...
//         // 페이지 로드 완료 시 toggleInputs() 함수 호출하여 초기 상태 설정
...
<!-- 					<div> -->
<!-- 							<span>배송지 주소</span> -->
<%-- 							<span id="buyerAddr">${buyer.mem_address}</span> --%>
<!-- 					        <div class="addr"> -->
				...
				<li class="drv_per_p res-com">
					...
					<ul class="side_sub">
						...
						<li class="drv_phone">
							...
							<div>
								<input type="text" size="1" maxlength="3" id="phone1" name="dri_tel1" value="">-
								<input type="text" size="3" maxlength="4" id="phone2" name="dri_tel2" value="">-
								<input type="text" size="3" maxlength="4" id="phone3" name="dri_tel3" value="">
							</div>
						</li>
						<li>
