...
<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/etc/bootstrap.bundle.min.js"></script>
	                ...
	                <li class="drv_per_p res-com">
	                    ...
	                    <ul class="side_sub">
	                        ...
	                        <li>
	                            ...
	                            <div>
	                                <input id="postcode" name="postcode" type="text" placeholder="우편번호">
    ...
    <script>
         $(function() {
       	 ...
       	 const deliveryCheck = () => {
       		 // 주소
             let address = '';
       		 console.log("!: ${buyer.delivery_address}");
             if("${buyer.delivery_address}" == "") {
            	 address = "${buyer.mem_address}";
             } else {
            	 address = "${buyer.delivery_address}";
             }
             let addrArr = address.split("/");
             if(addrArr[0] != null) $("#postcode").val(addrArr[0]);
             if(addrArr[1] != null) $("#address").val(addrArr[1]);
             if(addrArr[2] != null) $("#detailAddress").val(addrArr[2]);
             if(addrArr[3] != null) $("#extraAddress").val(addrArr[3]);
