...
<!-- 파비콘 -->
<link rel="icon"
	href="${pageContext.request.contextPath }/resources/img/main_ex/market/favicon.ico">
<style type="text/css">
				...
				<div class="container text-center">
					<div id="top_header_menu" class="row justify-content-between">
						<div class="col-4 top_header_icon">
							<a href="#"> <%--                                         <img src="${pageContext.request.contextPath }/resources/img/market/download.svg" alt="앱 다운로드"> 앱다운로드 --%>
							</a> <a href="#"> <%--                                         <img src="${pageContext.request.contextPath }/resources/img/market/bookmark.svg" alt="즐겨찾기"> 즐겨찾기 --%>
							</a>
						</div>
						<div class="col-6">
			...
			<div class="container text-center hamburger_area">
				<div class="row">
					<div class="col-md-1 hamburger">
						<img id="menu"
							src="${pageContext.request.contextPath }/resources/img/main_ex/market/hamburger.png"
							alt="메뉴">
					</div>
					<div class="col-md-4 sell_center">
						<p style="width: 280px">
							<a href="product_list" style="color: black;">중고거래 </a> <a
								...
								href="goodsStore.ad" style="color: black;">굿즈 스토어 </a> <a
					...
					<div id="test_area">
						...
						<ul id="test_hobby">
							...
							<li id="test_hobbyC"><a
								href="product_category?param=문구/사무용품">문구/사무용품</a></li>
							<li id="test_hobbyD"><a
								href="product_category?param=꽃/이벤트용품">꽃/이벤트용품</a></li>
						</ul>
						<!-- 소 분류 -->
						<ul id="test_hobbyAA">
							<h3>반려동물용품</h3>
						...
						<ul id="test_digital">
							<h3>디지털</h3>
							<li id="test_digitalA"><a
								href="product_category?param=노트북/데스크탑">노트북/데스크탑</a></li>
							<li id="test_digitalB"><a
								href="product_category?param=모니터/프린터">모니터/프린터</a></li>
							<li id="test_digitalC"><a
								href="product_category?param=PC주변기기">PC주변기기</a></li>
						...
						<ul id="test_sports">
							<h3>스포츠/레저</h3>
							<li id="test_sportsA"><a
								href="product_category?param=스포츠의류/운동화">스포츠의류/운동화</a></li>
							<li id="test_sportsB"><a
								href="product_category?param=등산/아웃도어/캠핑/낚시">등산/아웃도어/캠핑/낚시</a></li>
							<li id="test_sportsC"><a href="product_category?param=스포츠용품">스포츠용품</a></li>
							<li id="test_sportsD"><a
								href="product_category?param=자전거/보드/기타레저">자전거/보드/기타레저</a></li>
						</ul>
						<!-- 소 분류 -->
						<ul id="test_sportsAA">
							<h3>스포츠의류/운동화</h3>
						...
						<ul id="test_beauty">
							<h3>뷰티</h3>
							<li id="test_beautyA"><a
								href="product_category?param=화장품/향수">화장품/향수</a></li>
						...
						<ul id="test_car">
							...
							<li id="test_carB"><a
								href="product_category?param=공구/안전/산업용품">공구/안전/산업용품</a></li>
						</ul>
						<!-- 소 분류 -->
						<ul id="test_carAA">
							<h3>자동차용품</h3>
						...
						<ul id="test_book">
							<h3>도서/기타</h3>
							<li id="test_bookA"><a
								href="product_category?param=도서/교육/음반">도서/교육/음반</a></li>
							<li id="test_bookB"><a
								href="product_category?param=백화점/제화상품권">백화점/제화상품권</a></li>
							<li id="test_bookC"><a href="product_category?param=여행/항공권">여행/항공권</a></li>
							<li id="test_bookD"><a
								href="product_category?param=e쿠폰/모바일상품권">e쿠폰/모바일상품권</a></li>
						</ul>
						<!-- 소 분류 -->
						<ul id="test_bookAA">
							<h3>도서/교육/음반</h3>
