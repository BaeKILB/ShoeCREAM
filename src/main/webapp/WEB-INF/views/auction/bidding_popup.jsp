...
<h3>입찰하기</h3>   
<hr>
<h4>현재가 : el원 | 즉시구매가 :${auction.auc_buy_instantly }원</h4>
<!-- <h4>입찰 수량</h4> <input type="text" >개 -->
<!-- 입찰 수량은 판매 수량보다 클수없게 제약 -->
<h4>입찰 금액</h4> <input type="text" id="bid_price" oninput="calculateGuaranteeAmount()">원
<!-- 올리는 단위 정하기ㅏ 보증금 정하기 -->
<h4>보증금 </h4> <input type="text" id="guarantee_amount" name="deposit" readonly>원 <input type="button" value="보증금 결제하기" onclick="">
<!-- 보증금 입찰 금액의 10퍼 -->
<br>
<input type="button" value="입찰하기(테스트용)"id="bidButton" >
