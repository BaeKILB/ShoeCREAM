...
<body>
	<main class="container">
		...
		<div class="row mb-3">
			<div class="col">
				<form action="trackingRegister" method="post" class="container bg-light rounded-3">
					...
					<div class="mb-3 row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control-plaintext" id="auction_title" value="${auction.auction_title }" readonly>
						</div>
					</div>
					<div class="mb-3 row">
