...
<!-- <body> -->
			<li class="ct_mc_item">
				<div class="ct_lc_item_btn">
					<a href="" class="ct_lc_${param.i }" id="">${param.mc.mc_name }</a>
					<button id="ct_mc_${param.mc.mc_code }" class="ct_up_down_btn" onclick="allScListHidden(this); categoryBtnDrop(this);"></button>
				</div>
