	...
	<section id="main_cont">
		<div class="inq_container">
			...
			<section id="admin_cont">
				<form action="${pageContext.request.contextPath }/QstMemberWritePro"
					method="post">
					<hr class="tit_line">
					<div class="question_cont">
						<div class="mem_list_wrap">
							<div class="list_wrap">
								<ul class="list">
									<li>
										<div class="subject">${inquiry.qst_subject }</div>
									</li>
									<li class="write_info">
										<div class="write_box">
											<span class="write_t">작성자명</span> <span class="write_c">
												<input type="text" name="mem_name" id="mem_name"
												class="inputBox" value="${member.mem_name}" readonly>
											</span>
										</div> <!-- 							<div class="write_box"> --> <!-- 								<span class="write_t">등록일</span> -->
										<!-- 								<span class="write_c"> --> <%-- 									<fmt:formatDate value="${member.qst_date }" pattern="yy-MM-dd HH:mm"/> --%>
										<!-- 								</span> --> <!-- 							</div> -->
										<div class="category">
											<span class="write_t">문의유형</span> <span class="write_c">
							...
							<div class="list_wrap modify">
									...
									<li>
										<div class="subject">
											<input type="text" value="" class="inputBox"
												name="qst_subject" placeholder="제목을 입력해주세요"
												required="required">
										</div>
									</li>
								</ul>
								<div class="write_cont">
									<p>
										<textarea style="white-space: pre-line;" class="inputBox"
											placeholder="내용을 입력해주세요" name="qst_content"
											required="required"></textarea>
									</p>
								</div>
								<div class="mod_box">
									<input type="submit" class="list_btn" value="등록하기"> <a
										class="list_btn"
										href="${pageContext.request.contextPath }/mypage/questionList?pageNum=${param.pageNum }">목록</a>
								</div>
							</div>
						</div>
					</div>
