...
<!-- 						#바지 #바지 #바지 #바지 #바지 -->
					...
					<div class="button_array">
						...
						<div style=" cursor: pointer;" onclick="location.href='resCancel?product_idx=${jungGoNoh.product_idx}&mem_idx=${jungGoNoh.mem_idx}&buyier_idx=${principal.member.mem_idx}';">
							예약 실패
						</div>
						<div style=" cursor: pointer;" onclick="location.href='payComplete?product_idx=${jungGoNoh.product_idx}&mem_idx=${jungGoNoh.mem_idx}&buyier_idx=${principal.member.mem_idx}';">
							결제 완료
						</div>
						<div style=" cursor: pointer;" onclick="location.href='payCancel?product_idx=${jungGoNoh.product_idx}&mem_idx=${jungGoNoh.mem_idx}&buyier_idx=${principal.member.mem_idx}';">
							결제 취소
						</div>
						<div style=" cursor: pointer;" onclick="location.href='tradeComplete?product_idx=${jungGoNoh.product_idx}&mem_idx=${jungGoNoh.mem_idx}&buyier_idx=${principal.member.mem_idx}';">
							거래 완료
						</div>
						<div style=" cursor: pointer;" onclick="location.href='tradeCancel?product_idx=${jungGoNoh.product_idx}&mem_idx=${jungGoNoh.mem_idx}&buyier_idx=${principal.member.mem_idx}';">
							거래 취소
						</div>
